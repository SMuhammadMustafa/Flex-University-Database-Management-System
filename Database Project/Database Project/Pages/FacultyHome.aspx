<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FacultyHome.aspx.cs" Inherits="DB_Project.Pages.FacultyHome" %>
  ...
  <body>
    ...
    <div class="profile">
      ...
      <div class="section">
        ...
        <ul>
          <li><span class="spanBold">Username:</span> <asp:Label ID="labelUserId" runat="server" /> </li>
