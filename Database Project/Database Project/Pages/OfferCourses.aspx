...
.link-btn {
  ...
  <body>
    ...
    <form runat="server">
      ...
      <asp:DropDownList ID="electiveAssigned" runat="server" class="input">
      ...
      <asp:DropDownList ID="semester" runat="server" class="input">
      ...
      <asp:Button ID="btnOfferCourse" runat="server" Text="Offer Course" OnClick="OnRegister"/>        
      <br />
