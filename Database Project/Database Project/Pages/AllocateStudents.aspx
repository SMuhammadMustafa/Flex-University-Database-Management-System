<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllocateStudents.aspx.cs" Inherits="Project_DB.Pages.AllocateStudents" %>
...
.link-btn {
  ...
  <body>
    ...
    <form runat="server">
      ...
      <asp:DropDownList ID="rollNumber" runat="server"></asp:DropDownList>   

      <label for="courseCode">Course Code:</label>
      <asp:DropDownList ID="courseCode" runat="server"></asp:DropDownList>

      <label for="sectionName">Section Name:</label>
      <asp:DropDownList ID="sectionName" runat="server"></asp:DropDownList>
      
      <asp:Button ID="btnSet" runat="server" Text="Allocate" OnClick="OnAllocate" />        
