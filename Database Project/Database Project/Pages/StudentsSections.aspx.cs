    ...
    public partial class StudentsSections : System.Web.UI.Page
    {
        ...
        protected void UpdateTable(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                string query = "SELECT DISTINCT USERID, NAME, SECTIONNAME FROM USERS INNER JOIN COURSETAKING CT ON CT.STUDENTID = USERS.USERID INNER JOIN SECTIONS ON CT.SECTIONID = SECTIONS.SECTIONID ORDER BY SECTIONNAME";
