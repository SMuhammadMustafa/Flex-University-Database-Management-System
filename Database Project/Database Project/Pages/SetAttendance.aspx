<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetAttendance.aspx.cs" Inherits="Database_Project.Pages.SetAttendance" %>
        ...
        <div class="profile">
            <div class="section">
                <form runat="server">
                    ...
                    <asp:DropDownList runat="server" ID="course" AutoPostBack="true" OnSelectedIndexChanged="OnChangeCourse"></asp:DropDownList>
                    <br /><label>Section: </label><br />
                    <asp:DropDownList runat="server" ID="section" AutoPostBack="true" OnSelectedIndexChanged="OnChangeSection"></asp:DropDownList>
                    <br /><label>Lecture Number: </label>
                    <br />
                    <asp:Textbox type="text" runat="server" id="lectureNum"></asp:Textbox>
                    <br />
                    <label>Duration: </label>
                    <br />
                    <asp:Textbox type="text" runat="server" id="duration" />
                    <br />
                    ...
                    <asp:Button runat="server" ID="button" Text="Set" OnClick="OnSearchButton_Click" />
                    <br />
