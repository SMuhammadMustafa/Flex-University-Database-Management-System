...
namespace DB_Project.Pages
{
    public partial class Attendance : System.Web.UI.Page
    {
        ...
        private void PopulateCourseDropdown()
        {
            ...
            {
                string query = "SELECT C.courseCode, C.courseCode + ' - ' + C.courseName As courseName FROM COURSES C JOIN COURSETAKING CT ON C.courseCode = CT.courseCode WHERE CT.studentID = @username AND CT.active = 'Y';"; 
