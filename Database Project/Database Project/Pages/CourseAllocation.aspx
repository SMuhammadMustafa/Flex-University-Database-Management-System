<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseAllocation.aspx.cs" Inherits="DB_Project.Pages.CourseAllocation" %>

<!DOCTYPE html>
<html>
  <head>
    <link rel="icon" href="favicon.ico" type="image/x-icon">
    <title>Flex Academic Portal - Course Allocation</title>
    <style>
...
margin-top: 20px;
  ...
  <body>
    ...
    <h1 class="flex-text">Course Allocation</h1>
    <div class="linkbar">
