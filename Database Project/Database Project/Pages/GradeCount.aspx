<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeCount.aspx.cs" Inherits="Project_DB.Pages.GradeCount" %>

<!DOCTYPE html>
<html>
<head>
    <link rel="icon" href="favicon.ico" type="image/x-icon">
    <title>Flex Academic Portal - Grade Report</title>
    <style>
        body {
...
<body>
    ...
    <h1 class="flex-text">Grade Report</h1>
    <div class="linkbar">
        ...
        <div class="section">
            <div class="form-group">
                <form runat="server">
                    ...
                    <asp:DropDownList runat="server" ID="section" AutoPostBack="true" OnSelectedIndexChanged="OnChangeCourse"></asp:DropDownList>
                    ...
                    <div class="table-container">
                        <asp:Table runat="server" ID="table"></asp:Table>
                    </div>
                </form>
            </div>
        </div>
